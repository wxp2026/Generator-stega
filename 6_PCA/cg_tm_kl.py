...
def split_words(line, num):
    """
    将每行DNA序列按给定的长度 `num` 进行分割
    :param line: DNA序列（字符串）
    :param num: 每个子序列的长度
    :return: 返回一个分割后的列表
    """
...
def shuffle(path):
    ...
    path_shuffle = r'./data/read_5-shuffle/read_5-shuffle.txt'
...
if __name__ == '__main__':
    ...
    dp_sc = r"./data/line_888kb_5/rnn_fxy1-9_huf_fxy_0.txt"
    dp_or = r'./data/read_1.txt'
